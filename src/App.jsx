  ...
  return (
    <div className="app">
      ...
      <main className="main" onTouchStart={ptrStart} onTouchMove={ptrMove} onTouchEnd={ptrEnd}>
        ...
        {view === 'dashboard' && <Dashboard refreshKey={refreshKey} trips={data.trips} documents={data.documents} people={data.people} packing={data.packing} plans={data.plans} setView={setView} vaultKey={vaultKey} reload={reload} />}
        {view === 'trips' && <Trips trips={data.trips} documents={data.documents} people={data.people} plans={data.plans} reload={reload} hiddenTripCount={data.hiddenTripCount} />}
